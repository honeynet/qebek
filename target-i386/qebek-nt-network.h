...
extern uint16_t index_NtDeviceIoControlFile;
extern uint16_t index_NtWaitForSingleObject;

extern uint32_t NtDeviceIoControlFile;
extern uint32_t NtWaitForSingleObject;
